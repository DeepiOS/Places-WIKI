...
+ (instancetype)wmf_placesActivityWithURL:(NSURL *)activityURL {
    ...
    for (NSURLQueryItem *item in components.queryItems) {
        ...
        /// Added place name received from deep-link.
        if ([item.name isEqualToString:@"WMFLocationName"]) {
            [userInfo setObject:item.value forKey:@"WMFLocationName"];
            break;
        }
    }
...
- (NSString *)wmf_placeNameToSearch {
